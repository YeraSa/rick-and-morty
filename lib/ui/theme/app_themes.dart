...
final appThemeData = {
  ...
  AppTheme.LightTheme: ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      backgroundColor: Color.fromRGBO(3, 184, 152, 1),
    ),
    backgroundColor: const Color.fromRGBO(228, 229, 241, 0),
    cardColor: const Color.fromRGBO(3, 184, 152, 1),
    indicatorColor: const Color.fromRGBO(74, 74, 74, 1),
    fontFamily: 'Georgia',
    textTheme: const TextTheme(
      headline1: TextStyle(
          fontSize: 50,
      ...
      headline2: TextStyle(
          ...
          color: Color.fromRGBO(74, 74, 74, 1)),
      headline3: TextStyle(fontSize: 24, color: Color.fromRGBO(74, 74, 74, 1)),
      bodyText1: TextStyle(
          fontSize: 12,
